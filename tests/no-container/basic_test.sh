...
function test_pid_files_exist() {
    assert_file_exists "${DEFAULT_DIR}/elasticsearch.pid"
}

function test_no_docker_compose_file() {
    assert_file_not_exists "${DEFAULT_DIR}/docker-compose.yml"
}
