...
function set_up_before_script() {
    sh "${CURRENT_DIR}/${SCRIPT_FILE}" --no-container --esonly
...
function test_no_kibana_directory() {
    assert_directory_not_exists "${DEFAULT_DIR}/kibana"
}

function test_no_kibana_pid() {
